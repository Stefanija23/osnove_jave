...
//    (RSD/USD/RUB) a vraca konvertovanu vrednost.
...
//    1 EUR = 62.98 RUB
    ...
    public static void main(String[] args) {
        ...
        double rezultat = konverzijaEura(eur,valuta);
        System.out.println("Konverzija eura u druge valute je: " + rezultat);
    }

    public static double konverzijaEura (double eur, String valuta ) {

        if (valuta.equals("RSD")) {
            double rsd = eur * 117.5;
            return rsd;
            } else if (valuta.equals("USD")) {
            double usd = eur * 1.1;
            return usd;
        } else if (valuta.equals("RUB")) {
            double rub = eur * 62.98;
            return rub;
        } else {
            return 0;
    }
